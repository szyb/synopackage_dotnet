  ...
  ngOnInit(): void {
    this.privacyPolicies = [
      ...
      },
      {
        ...
        // tslint:disable-next-line:max-line-length
        description: 'We do want to know what devices are in use. Those logs are stored anonymously, so <b>we do not store your IP nor any other your personal information</b>. However your IP is collected by the hosting web server, which is outside our jurisdiction, but we have access to those logs.'
      },
      {
